...
export function SectionTitle({ pill, title, subtitle }: Props) {
  return (
    <MotionReveal className="mb-10 max-w-2xl">
      <span className="inline-flex items-center rounded-full bg-secondary-container px-3.5 py-1 font-display text-sm font-bold tracking-wide text-on-secondary-container">
        {pill}
      </span>
