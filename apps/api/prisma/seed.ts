...
const configuraciones = [
  ...
  },
  {
    ...
    valor: 25,
    descripcion: 'Capacidad base del evento (niños incluidos sin cargo en el paquete)',
    esPublico: true,
  },
  {
  ...
  },
  {
    ...
    valor: 25,
    descripcion: 'Niños incluidos en el paquete sin cargo adicional (capacidad del local, no requiere show)',
    esPublico: true,
  },
  {
    clave: 'shows.precio_nino_extra',
    valor: 25,
    descripcion: 'Precio por niño adicional (Refugio Gastronómico) fuera del rango incluido (S/)',
    esPublico: true,
  },
  {
