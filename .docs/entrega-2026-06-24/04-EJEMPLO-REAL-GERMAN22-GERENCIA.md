...
## 8. Fase 5 — Contrato y pedidos (antes de confirmar agenda)

**Rol:** Vendedor / operación  
**Estado evento:** **Por confirmar**

> Desde junio 2026 el sistema **no permite Confirmar evento** hasta tener contrato **Enviado/Firmado** y pedidos de proveedor **Confirmados**.

### Paso 5.1 — Verificar en Dashboard

1. **Dashboard** → sección **Próximos eventos**.
2. Busca el evento de **Sofía — Germán Huaytalla**.
3. Clic en el evento → abre Agenda con detalle.

### Paso 5.2 — Generar y enviar contrato

1. En detalle del evento → **Generar contrato**.
2. Completar DNI, adelanto, horario → **Imprimir/PDF** → **Enviar WhatsApp** → **Marcar enviado**.

### Paso 5.3 — Pedidos a proveedor

1. **Generar desde cotización** (si hay ítems proveedor).
2. Compartir **link público** al proveedor (`/pedido/:token`) hasta estado **Confirmado**.
3. Opcional: **+ Pedido** manual para show u otros.

**Qué decir a gerencia:** *«Antes de bloquear la fecha en agenda, el sistema exige contrato enviado y confirmación del proveedor — menos riesgo operativo.»*

---

## 9. Fase 6 — Confirmar la fiesta vendida (Panel → Agenda)

### Paso 6.1 — Confirmar evento

1. Revisar cliente, fecha, turno, 22 niños.
2. Pulsa **Confirmar evento** (solo disponible si contrato + pedidos OK).

**Estado evento:** **Confirmado**.

---

## 10. Fase 7 — Logística: checklist y operaciones (Agenda → detalle)

**Rol:** Operación

### Paso 7.1 — Checklist del evento

Sección **Checklist**:

1. Pulsa **Generar checklist** (si está vacío).
2. Marca tareas: **Pendiente** → **En proceso** → **Completado**.

### Paso 7.2 — Vista Operaciones

1. **Operaciones** → rango de fechas de la semana del evento.
2. Verificar pedidos y costo estimado.

**Qué decir a gerencia:** *«Cada fiesta tiene checklist y pedidos visibles en un solo lugar.»*

---

## 11. Fase 8 — Adjuntos y cierre de contrato (Agenda o Contratos)

**Rol:** Vendedor

### Paso 8.1 — Adjuntos (opcional en demo)

1. Arrastrar **comprobante de pago** y **documento contabilidad** al contrato.
2. Marcar **Firmado** si el cliente confirmó por fuera del sistema.

**Qué decir a gerencia:** *«El contrato congela un snapshot de la cotización. Los adjuntos de pago y contabilidad quedan archivados en el mismo expediente.»*

---

## 12. Fase 9 — Vista gerencial de operaciones (Operaciones)
...
## 13. Fase 10 — Cierre: fiesta realizada (Agenda)
