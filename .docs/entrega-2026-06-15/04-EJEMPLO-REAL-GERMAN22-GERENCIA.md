...
| **Temática** | Princesas |
| **Paquete** | Premium |
| **Fecha tentativa** | ~2 semanas desde hoy (ej. si hoy es 15/06/2026 → **29/06/2026**) |
...
1. En sección **Seguimiento**, escribe notas de ejemplo:
   ...
   > *«15/06 — Llamada inicial. Confirma fecha tentativa y paquete Premium. Interesado en show de magia. Envío cotización por WhatsApp.»*
